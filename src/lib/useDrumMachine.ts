...
import kick from 'assets/sounds/drums/track1.wav';
import closed from 'assets/sounds/drums/track2.wav';
import clap from 'assets/sounds/drums/track3.wav';
import open from 'assets/sounds/drums/track4.wav';
